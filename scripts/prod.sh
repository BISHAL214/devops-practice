...
# Production deployment script for Devops Practice App
# This script starts the application in production mode with Neon Cloud Database

echo "🚀 Starting Devops Practice App in Production Mode"
echo "==============================================="
...
echo "   Logs: docker logs devops-practice-app-prod"
echo ""
echo "Useful commands:"
echo "   View logs: docker logs -f devops-practice-app-prod"
